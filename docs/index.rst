...
Even better than creating an issue is creating a pull request. If you want to do that please read the :doc:`development introduction </development/introduction>`.
