...
class PKPJourneysRequest(BaseJourneysRequest, JourneysRequestInterface):
    """
    Class for the PKP Journeys requests, because the id of the journey is in jny['recon']['ctx] instead of
    jny['ctxRecon']
    """
