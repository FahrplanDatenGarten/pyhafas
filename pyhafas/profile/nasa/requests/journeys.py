...
class NASAJourneysRequest(BaseJourneysRequest, JourneysRequestInterface):
    '''
    Class for the NASA Journeys requests, because the id of the journey is in jny['recon']['ctx] instead of jny['ctxRecon']
    '''
